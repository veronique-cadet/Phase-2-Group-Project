...
const getWaterCountByWater = (logs) => {
  ...
  return (
    <div className="description-box">
      ...
      <p className="description">Make sure you’re staying hydrated! The height of each bar on this graph indicates how many days throughout the week that you drank the corresponding number of cups of water.</p>
